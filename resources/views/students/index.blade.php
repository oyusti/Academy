<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight flex items-center justify-between">
            {{ __('Alumnos') }}
            <a href="{{ route('students.create') }}" class="text-xs bg-red-800 text-white rounded px-2 py-1">Crear</a>
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <table class="mb-4">
                    ...
                    <tbody>
                        <tr class="border-b border-gray-200 text-sm">
                                <td class="px-6 py-4"><a href="{{ route('students.show', $student) }}" class="text-indigo-600">{{ $student->name }}</a></td>
